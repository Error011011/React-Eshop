...
import Image3 from '../../assets/hero/vr.png';
...
const Hero = () => {
  ...
  return (
    <section className='container'>
        <div className='overflow-hidden rounded-3xl min-h-[550px] sm:min-h-[650] hero-bg-color flex justify-center items-center'>
                        ...
                        HeroSlide.map((data) => (
                            <div key={data.id}>
                                <div className="grid grid-cols-1 sm:grid-cols-2">
                                    ...
                                    {/* image content */}
                                    <div data-aos="zoom-in" data-aos-once="true" className='order-1 sm:order-2 relative z-10'>
                                        <img src={data.img} alt="image" className='w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] sm:scale-105 lg:scale-120 object-contain mx-auto drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)] relative z-40'/>
                                    </div>
                                </div>
                            </div>
                        ))
